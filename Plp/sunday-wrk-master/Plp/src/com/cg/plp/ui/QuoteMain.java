...
public class QuoteMain {
	...
	
	{
		...
		try {
		if(role_code==1) {
			System.out.println("User Priviledges Granted!!!");
...
//			
		...
		{
			//logger.error("exception occured ", InsuranceException);
			System.out.println("ERROR : " +ie.getMessage());
		}
		
		userLoginBean=null;
		 accountCreationBean=null;
		 policyCreationBean=null;
